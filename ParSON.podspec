#
#  Be sure to run `pod spec lint ParSON.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Genhain/ParSON"
  ...
  # Or just: s.author    = "Genhain"
  # s.authors            = { "Genhain" => "voxhavoccanis@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Genhain"
  ...
  s.source       = { :git => "https://github.com/Genhain/ParSON.git", :tag => "#{s.version}" }
